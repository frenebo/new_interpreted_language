...
namespace virtual_machine::machine_state
{
    ...
    private:
        ...
        std::optional<MachineRuntimeError> execute_stack_bool_push_const(bool bool_to_push);
        std::optional<MachineRuntimeError> execute_stack_string_push_const(std::string string_to_push);
        ...
        std::optional<MachineRuntimeError> execute_stack_or_operation();
    };
}
